  ...
  return (
    <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2 rounded-lg border ${
              errors.id ? 'border-red-500 focus:ring-red-200' : 'border-slate-300 focus:ring-blue-600/30 focus:border-blue-600'
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2 rounded-lg border ${errors.title ? 'border-red-500 focus:ring-red-200' : 'border-slate-300 focus:ring-blue-600/30 focus:border-blue-600'} outline-none focus:ring-2 transition-all`}
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-600/30 focus:border-blue-600 outline-none transition-all resize-none"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-600/30 focus:border-blue-600 outline-none"
            />
            ...
            <div className="flex items-center justify-between mb-1 h-5">
              ...
              <label className="flex items-center cursor-pointer scale-75 origin-right">
                <div className="relative">
                  ...
                  <div className={`block w-14 h-8 rounded-full transition-colors ${hasEndTime ? 'bg-blue-600' : 'bg-slate-200'}`}></div>
        ...
        <div className="flex items-center justify-between">
          ...
          <label className="flex items-center cursor-pointer">
            <div className="relative">
              ...
              <div className={`block w-14 h-8 rounded-full transition-colors ${hasRepeat ? 'bg-blue-600' : 'bg-slate-200'}`}></div>
          ...
          <div className="space-y-6 pt-4 border-t border-slate-100 animate-in fade-in slide-in-from-top-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  {...register('frequency')}
                  className="w-full px-4 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-600/30 focus:border-blue-600 outline-none bg-white"
                >
              ...
              <div>
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="w-full px-4 py-2 rounded-l-lg border border-slate-300 focus:ring-2 focus:ring-blue-600/30 focus:border-blue-600 outline-none"
                  />
                          ...
                          <button
                            ...
                            className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-medium transition-all ${
                              isSelected
                                ...
                                : 'bg-white border border-slate-200 text-slate-600 hover:border-blue-600/50 hover:bg-slate-50'
                            }`}
                          >
                            {day.label}
                          </button>
      ...
      <div className="flex items-center gap-4 pt-4">
        <button
            type="submit"
            className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 rounded-xl shadow-lg shadow-blue-200 transition-all flex justify-center items-center gap-2"
          >
